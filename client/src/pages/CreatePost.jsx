...
export default function CreatePost() {
    ...
    const handleUploadImage = async () => {
        try {
            ...
            uploadTask.on(
                ...
                (error) => {
                    setImageUploadError('falha ao subir a imagem');
            ...
            setImageUploadError('Erro no upload da imagem');
            setImageUploadProgress(null);
            console.log(error);      
        }
    };
  ...
  return <div className='p-3 max-w-3xl mx-auto min-h-screen'>
    ...
    <form className='flex flex-col gap-4'>
        ...
        <Button type='submit' gradientDuoTone='greenToBlue' onClick={handleUploadImage}>Publicar</Button>
